      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
        <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl p-6 sm:p-7">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <Link
              href={buildGamePath('69b52f0660f9e6d7a4183316', 'Cyberpunk 2077')}
            ...
            <Link
              href={buildGamePath('69b7713923c3b3b3ff8a4ca2', 'Elden Ring')}
            ...
            <Link
              href={buildGamePath('69b52f0660f9e6d7a4183327', 'Red Dead Redemption 2')}
            ...
            <Link
              href={buildGamePath('69b52f0660f9e6d7a4183326', 'Hogwarts Legacy')}

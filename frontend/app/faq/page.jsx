    ...
    <div className="pt-32 pb-24 px-6 max-w-4xl mx-auto">
      ...
      <section className="mt-20 p-10 rounded-2xl glass-panel relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <Link href="/contact" className="px-8 py-4 rounded-xl bg-gradient-to-br from-primary to-secondary-container text-on-primary-container font-bold hover:scale-105 transition-transform active:scale-95 shadow-lg shadow-primary/20">
            Contact Support
          </Link>
        </div>
      </section>
